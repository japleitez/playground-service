...
public final class TestUtil {
    ...
    public static JsonNode getJsonNodeFromResource(String resourceName) throws IOException {
    ...
    public static String readStringFromResource(String name) throws URISyntaxException, IOException {
        return new String(Files.readAllBytes(Paths.get(ClassLoader.getSystemClassLoader().getResource(name).toURI())));
    }
